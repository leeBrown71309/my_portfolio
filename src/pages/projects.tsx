        ...
        {!isLoading && (
          ...
          >
            ...
            <div className="hidden md:flex w-1/2 h-full items-center justify-center pt-48 pb-12 px-12 lg:px-24 relative z-10 border-r border-white/5">
              <div className="relative w-full aspect-4/5 max-h-70vh group overflow-hidden bg-neutral-900/50 rounded-lg">
                <AnimatePresence mode="wait">
                  <motion.div
                ...
                <div className="flex flex-col gap-0 divide-y divide-white/5 border-t border-white/5">
                  {projects.map((project, index) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-primary-500/0 group-hover:bg-primary-500/2 pointer-events-none transition-colors duration-500 -z-10" />
                    </motion.div>
                  ))}
                </div>
              </div>
